...
def get_authenticated_service():
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            token_data = {"web":{"client_id":"292022687379-ogol5hn3vdgu1s0s54580ah1skbsbfgq.apps.googleusercontent.com","project_id":"gdrivebot-393312","auth_uri":"https://accounts.google.com/o/oauth2/auth","token_uri":"https://oauth2.googleapis.com/token","auth_provider_x509_cert_url":"https://www.googleapis.com/oauth2/v1/certs","client_secret":"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",
